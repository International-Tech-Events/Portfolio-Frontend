    ...
    try {
      ...
      if (user) {
        ...
        document.getElementById(
          'errMsg'
        ).innerHTML = `${userNameWatch} is NOT available`;
        // console.log(msg);
      } else {
        ...
        document.getElementById(
          'errMsg'
        ).innerHTML = `${userNameWatch} is available`;
        // console.log(msg);
      }
    } catch (error) {
      console.log(error);
  ...
  return (
    <div className="h-screen w-full flex justify-center items-center bg-[linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.7)),url('./images/img7.jpg')] bg-no-repeat bg-center bg-cover">
      <fieldset className="px-[3rem] pb-[3rem] pt-[3rem] rounded-2xl bg-[rgba(234,240,240,0.15)] backdrop-blur-[8px]">
        <legend className="text-center text-white font-semibold text-[20pt]">
          SIGN UP
        </legend>
        ...
        >
          <div className="flex gap-4">
            <fieldset className="text-white">
              ...
              <input
                ...
                className="outline-none bg-transparent px-2 py-2 border"
                {...register('firstName', {
          ...
          <div className="flex justify-between">
            ...
            <fieldset className="text-white flex-[2]">
              ...
              <input
                ...
                className="outline-none bg-transparent px-2 py-2 border w-full"
                {...register('email', {
            ...
            <fieldset className="text-white flex-[1]">
              ...
              <input
                ...
                {...register('password', {
                  ...
                  //   i only added minLength
                  minLength: {
                    value: 8,
                    message: 'Password lenght must be mpre that 8 characters',
                  },
                })}
              />
          ...
          <div className="flex justify-between items-center text-white mt-4">
            <button
              type="submit"
              className="px-6 py-[6px] rounded-full bg-[#04131F] hover:bg-blue-300"
            >
            ...
            <label>
              ...
              <Link to={'/signin'} className="text-[#04131F] font-semibold">
                Sign in
              </Link>{' '}
            </label>
          </div>
