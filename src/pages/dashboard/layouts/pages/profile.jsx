...
// import { CameraIcon, MapPin, Cake, DownloadIcon } from 'lucide-react';
...
//                 />
//                 <CameraIcon className="absolute h-14 w-14 bg-gray-800 bottom-2 right-2 p-2 rounded-full cursor-pointer" />
//               </div>
//             </div>
//             <h1 className="mt-4 text-center text-xl font-bold">Ellen Akosua</h1>
...
//             <h2 className="text-center text-lg font-semibold">Social Media</h2>
...
//         {/* Right Section */}
//         <div className="md:w-2/3 p-4 bg-primary text-white rounded-tr-[10rem]">
